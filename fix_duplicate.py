...
# Remove old login, signup, and logout functions completely to avoid duplicate endpoint errors
patterns_to_remove = [
...
# Insert auth functions safely before if __name__ == '__main__':
auth_code = """
...
print("✅ Duplicate routes removed and patched clean!")
