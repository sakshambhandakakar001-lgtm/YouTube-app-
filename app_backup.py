...
<input type="email" name="email" placeholder="Enter your email" required style="width:100%; padding:10px; margin-bottom:10px; background:#222; border:1px solid #444; color:#fff; border-radius:5px;">
        ...
        <div class="feed" id="mainFeedContainer">
            ...
            <div class="video-card">
                <a href="/watch/{{ v['id'] }}" class="thumb-box">
                    <video preload="metadata" muted>{% if 'youtube.com/embed' in v['filename'] %}
<iframe src="{{ v['filename'] }}" style="width:100%; height:100%; border:none;" allowfullscreen></iframe>
{% else %}
<iframe src="{{ v['filename'].replace('watch?v=', 'embed/') if 'youtube.com' in v['filename'] else v['filename'] }}" style="width:100%; height:210px; border:none; background:#000;" allowfullscreen></iframe>
{% endif %}</video>
                </a>
    ...
    {% elif page == 'shorts_feed' %}
        <div class="shorts-feed-container">
            ...
            <div class="short-card-item">
                <video id="short_vid_{{ v['id'] }}" loop preload="auto" onclick="location.href='/watch/{{ v['id'] }}'" style="width:100%; height:100%; object-fit:cover;">{% if 'youtube.com/embed' in v['filename'] %}
<iframe src="{{ v['filename'] }}" style="width:100%; height:100%; border:none;" allowfullscreen></iframe>
{% else %}
<iframe src="{{ v['filename'].replace('watch?v=', 'embed/') if 'youtube.com' in v['filename'] else v['filename'] }}" style="width:100%; height:210px; border:none; background:#000;" allowfullscreen></iframe>
{% endif %}</video>
    ...
    {% elif page == 'history' %}
        <div style="padding:16px;">
            ...
            <div class="feed" style="margin-top:16px;">
                ...
                <div class="video-card">
                    <a href="/watch/{{ v['id'] }}" class="thumb-box"><video preload="metadata">{% if 'youtube.com/embed' in v['filename'] %}
<iframe src="{{ v['filename'] }}" style="width:100%; height:100%; border:none;" allowfullscreen></iframe>
{% else %}
<iframe src="{{ v['filename'].replace('watch?v=', 'embed/') if 'youtube.com' in v['filename'] else v['filename'] }}" style="width:100%; height:210px; border:none; background:#000;" allowfullscreen></iframe>
{% endif %}</video></a>
    ...
    {% elif page == 'downloads' %}
        <div style="padding:16px;">
            ...
            <div class="feed" style="margin-top:16px;">
                ...
                <div class="video-card">
                    <a href="/watch/{{ v['id'] }}" class="thumb-box">
                        <video preload="metadata">{% if 'youtube.com/embed' in v['filename'] %}
<iframe src="{{ v['filename'] }}" style="width:100%; height:100%; border:none;" allowfullscreen></iframe>
{% else %}
<iframe src="{{ v['filename'].replace('watch?v=', 'embed/') if 'youtube.com' in v['filename'] else v['filename'] }}" style="width:100%; height:210px; border:none; background:#000;" allowfullscreen></iframe>
{% endif %}</video>
...
def signup():
    ...
    if request.method == 'POST':
        ...
        try:
            conn = get_db()
            c = conn.cursor()
            c.execute("INSERT INTO users (username, email, password, handle) VALUES (?, ?, ?, ?)", (username, email, hashed_password, handle))
            conn.commit()
            user_id = c.lastrowid
            conn.close()
